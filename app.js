...
en:{
 ...
 valuePerformance:"Performance",valuePerformanceText:"Improve with organization and strategy.",
...
de:{
 ...
 valuePerformance:"Leistung",valuePerformanceText:"Mit Organisation und Strategie verbessern.",
...
es:{
 ...
 valuePerformance:"Rendimiento",valuePerformanceText:"Mejoramos con organización y estrategia.",
...
pt:{
 ...
 valuePerformance:"Rendimento",valuePerformanceText:"Melhoramos com organização e estratégia.",
...
fr:{
 ...
 valuePerformance:"Performance",valuePerformanceText:"Nous progressons avec organisation et stratégie.",
...
const DAILY = {
en:[
 {n:1,title:"Check events every day",text:"Complete the fixed daily events. CODE BREAKER: attack at least 3 times; on specific events, do 2 extra attacks for better rewards (5/5). ARMS RACE: synchronize each time slot with Alliance Duel.",imgs:[["events.jpg","Events"],["code-breaker.jpg","Code Breaker"],["arms-race.jpg","Arms Race"]]},
 {n:2,title:"Claim the free shop & Weekly Pass chests",text:"Open the Mall and Weekly Pass every day and claim every free chest or gift.",imgs:[["mall-1.jpg","Mall"],["mall-2.jpg","Mall"],["weekly-pass.jpg","Weekly Pass"]]},
 {n:3,title:"Arena: play & give a like",text:"Take part in Arena. Also like one featured player in Storm Arena and 3v3 Fight: those likes give gems.",imgs:[["arena.jpg","Arena"],["storm-arena.jpg","Storm Arena"],["arena-3v3.jpg","3v3"]]},
 {n:4,title:"Check the Alliance event schedule",text:"Use the Alliance building to see the events scheduled for the day.",imgs:[["alliance-center.jpg","Alliance Center"]]},
 {n:5,title:"Follow the red dots",text:"Red dots on tabs and menus mean there is something to collect, claim or complete. Clear them before finishing your daily routine.",imgs:[["red-dots.jpg","Red dots"]]},
 {n:6,title:"Honorable Campaign",text:"The Honorable Campaign is located in the Alert Tower. Send squads against tank, aircraft and missile challenges to earn important rewards and campaign points for useful gadgets in the campaign shop.",note:"Updates exactly every 48 hours.",imgs:[["campaign.jpg","Honorable Campaign"]]},
 {n:7,title:"Collect VIP points and rewards",text:"Enter the VIP area every day to collect your VIP points and the free daily VIP reward.",imgs:[["VIP1.jpg","VIP access"],["VIP2.jpg","Daily VIP reward"]]}
],
de:[
 {n:1,title:"Täglich die Events prüfen",text:"Erledige die festen täglichen Events. CODE BREAKER: mindestens 3-mal angreifen; bei bestimmten Events 2 Extra-Angriffe für mehr Belohnungen (5/5). ARMS RACE: Zeitfenster mit dem Allianzduell synchronisieren.",imgs:[["events.jpg","Events"],["code-breaker.jpg","Code Breaker"],["arms-race.jpg","Arms Race"]]},
 {n:2,title:"Kostenlose Shop- & Wochenpass-Truhen holen",text:"Öffne täglich den Shop und den Wochenpass und hole alle kostenlosen Truhen und Geschenke ab.",imgs:[["mall-1.jpg","Shop"],["mall-2.jpg","Shop"],["weekly-pass.jpg","Wochenpass"]]},
 {n:3,title:"Arena: spielen & ein „Gefällt mir“ geben",text:"Nimm an der Arena teil und gib in Sturmarena und 3v3 einem hervorgehobenen Spieler ein „Gefällt mir“; dafür gibt es Edelsteine.",imgs:[["arena.jpg","Arena"],["storm-arena.jpg","Sturmarena"],["arena-3v3.jpg","3v3"]]},
 {n:4,title:"Allianz-Eventplan prüfen",text:"Nutze das Allianzgebäude, um die für den Tag geplanten Events zu sehen.",imgs:[["alliance-center.jpg","Allianzzentrum"]]},
 {n:5,title:"Den roten Punkten folgen",text:"Rote Punkte zeigen, dass noch etwas abzuholen oder zu erledigen ist. Vor dem Tagesende prüfen.",imgs:[["red-dots.jpg","Rote Punkte"]]},
 {n:6,title:"Ehrenkampagne",text:"Die Ehrenkampagne befindet sich im Alarmturm. Schicke Trupps in Panzer-, Luft- und Raketen-Herausforderungen und verdiene wichtige Belohnungen sowie Kampagnenpunkte für nützliche Gegenstände im Kampagnen-Shop.",note:"Aktualisiert sich genau alle 48 Stunden.",imgs:[["campaign.jpg","Ehrenkampagne"]]},
 {n:7,title:"VIP-Punkte und Belohnungen abholen",text:"Öffne täglich den VIP-Bereich und hole deine VIP-Punkte sowie die kostenlose tägliche VIP-Belohnung ab.",imgs:[["VIP1.jpg","VIP-Zugang"],["VIP2.jpg","Tägliche VIP-Belohnung"]]}
],
es:[
 {n:1,title:"Revisa los eventos todos los días",text:"Completa los eventos fijos diarios. JEFE DE CÓDIGO: golpéalo al menos 3 veces; en eventos concretos, haz 2 ataques extra para obtener más recompensa (5/5). CARRERA DE ARMAS: sincroniza cada franja con el Duelo de Alianzas.",imgs:[["events.jpg","Eventos"],["code-breaker.jpg","Jefe de código"],["arms-race.jpg","Carrera de armas"]]},
 {n:2,title:"Recoge los cofres gratis de la tienda y Pase Semanal",text:"Entra cada día en el Centro Comercial y en el Pase Semanal y recoge todos los cofres y regalos gratuitos.",imgs:[["mall-1.jpg","Tienda"],["mall-2.jpg","Tienda"],["weekly-pass.jpg","Pase semanal"]]},
 {n:3,title:"Arena: participa y da «Me gusta»",text:"Participa en la Arena. Además, da «Me gusta» a algún jugador destacado en Arena de Tormenta y Pelea 3v3: conseguirás gemas.",imgs:[["arena.jpg","Arena"],["storm-arena.jpg","Arena de Tormenta"],["arena-3v3.jpg","3v3"]]},
 {n:4,title:"Consulta el horario de eventos de alianza",text:"Consulta el edificio de la alianza donde aparece la hora para saber qué eventos hay ese día.",imgs:[["alliance-center.jpg","Centro de alianza"]]},
 {n:5,title:"Sigue los puntos rojos",text:"Los puntos rojos en pestañas e iconos indican que aún queda algo por resolver o recoger. Revísalos antes de terminar tu rutina diaria.",imgs:[["red-dots.jpg","Puntos rojos"]]},
 {n:6,title:"Campaña Honorable",text:"La Campaña Honorable se encuentra en la Torre de Alerta. Permite enviar escuadrones para enfrentar retos de tanques, aeronaves y misiles, otorgando recompensas importantes y puntos para comprar artilugios muy útiles en la tienda de campaña.",note:"Se actualiza exactamente cada 48 horas.",imgs:[["campaign.jpg","Campaña Honorable"]]},
 {n:7,title:"Recoge los puntos y recompensas VIP",text:"Entra cada día en el apartado VIP para recoger tus puntos VIP y la recompensa VIP gratuita diaria.",imgs:[["VIP1.jpg","Acceso VIP"],["VIP2.jpg","Recompensa VIP diaria"]]}
],
pt:[
 {n:1,title:"Verifica os eventos todos os dias",text:"Completa os eventos fixos diários. CHEFE DE CÓDIGO: ataca pelo menos 3 vezes; em certos eventos, faz 2 ataques extra para mais recompensas (5/5). CORRIDA DE ARMAS: sincroniza cada período com o Duelo da Aliança.",imgs:[["events.jpg","Eventos"],["code-breaker.jpg","Chefe de Código"],["arms-race.jpg","Corrida de Armas"]]},
 {n:2,title:"Recolhe os baús grátis da loja e Passe Semanal",text:"Entra todos os dias no Centro Comercial e no Passe Semanal e recolhe todos os baús e presentes grátis.",imgs:[["mall-1.jpg","Loja"],["mall-2.jpg","Loja"],["weekly-pass.jpg","Passe Semanal"]]},
 {n:3,title:"Arena: participa e dá «Gosto»",text:"Participa na Arena e dá «Gosto» a um jogador em destaque na Arena da Tempestade e Luta 3v3 para receber gemas.",imgs:[["arena.jpg","Arena"],["storm-arena.jpg","Arena da Tempestade"],["arena-3v3.jpg","3v3"]]},
 {n:4,title:"Consulta o horário dos eventos da aliança",text:"Consulta o edifício da aliança para saber que eventos há nesse dia.",imgs:[["alliance-center.jpg","Centro da Aliança"]]},
 {n:5,title:"Segue os pontos vermelhos",text:"Os pontos vermelhos indicam que ainda há algo para resolver ou recolher. Revê-os antes de terminar a rotina diária.",imgs:[["red-dots.jpg","Pontos vermelhos"]]},
 {n:6,title:"Campanha Honrosa",text:"A Campanha Honrosa encontra-se na Torre de Alerta. Envia esquadrões para desafios de tanques, aeronaves e mísseis e recebe recompensas importantes e pontos para comprar objetos úteis na loja da campanha.",note:"Atualiza-se exatamente a cada 48 horas.",imgs:[["campaign.jpg","Campanha Honrosa"]]},
 {n:7,title:"Recolhe pontos e recompensas VIP",text:"Entra todos os dias na área VIP para recolher os teus pontos VIP e a recompensa VIP diária gratuita.",imgs:[["VIP1.jpg","Acesso VIP"],["VIP2.jpg","Recompensa VIP diária"]]}
],
fr:[
 {n:1,title:"Vérifie les événements chaque jour",text:"Fais les événements fixes quotidiens. BOSS DU CODE : attaque au moins 3 fois ; sur certains événements, fais 2 attaques supplémentaires pour plus de récompenses (5/5). COURSE AUX ARMES : synchronise les créneaux avec le Duel d’Alliance.",imgs:[["events.jpg","Événements"],["code-breaker.jpg","Boss du Code"],["arms-race.jpg","Course aux armes"]]},
 {n:2,title:"Récupère les coffres gratuits de la boutique et du Pass Hebdo",text:"Ouvre chaque jour le Centre commercial et le Pass hebdomadaire et récupère tous les coffres et cadeaux gratuits.",imgs:[["mall-1.jpg","Boutique"],["mall-2.jpg","Boutique"],["weekly-pass.jpg","Pass Hebdo"]]},
 {n:3,title:"Arène : participe et mets un « J’aime »",text:"Participe à l’Arène et mets un « J’aime » à un joueur mis en avant dans l’Arène de Tempête et le Combat 3v3 pour gagner des gemmes.",imgs:[["arena.jpg","Arène"],["storm-arena.jpg","Arène de Tempête"],["arena-3v3.jpg","3v3"]]},
 {n:4,title:"Consulte le programme des événements d’alliance",text:"Consulte le bâtiment de l’alliance pour voir les événements du jour.",imgs:[["alliance-center.jpg","Centre d’Alliance"]]},
 {n:5,title:"Suis les points rouges",text:"Les points rouges indiquent qu’il reste quelque chose à récupérer ou terminer. Vérifie-les avant de finir ta routine.",imgs:[["red-dots.jpg","Points rouges"]]},
 {n:6,title:"Campagne Honorable",text:"La Campagne Honorable se trouve dans la Tour d’Alerte. Envoie des escouades relever des défis de chars, d’aéronefs et de missiles pour obtenir des récompenses importantes et des points à dépenser dans la boutique de campagne.",note:"Elle se met à jour exactement toutes les 48 heures.",imgs:[["campaign.jpg","Campagne Honorable"]]},
 {n:7,title:"Récupère les points et récompenses VIP",text:"Ouvre chaque jour l’espace VIP pour récupérer tes points VIP et la récompense VIP quotidienne gratuite.",imgs:[["VIP1.jpg","Accès VIP"],["VIP2.jpg","Récompense VIP quotidienne"]]}
]
};
...
function renderDaily(){
 const target=document.getElementById("dailyGrid");
 target.innerHTML=DAILY[lang].map(item=>`
  <article class="guide-card">
    <div class="guide-head">
      <span class="guide-number">${item.n}</span>
      <div><h3>${item.title}</h3><p>${item.text}</p></div>
    </div>
    <div class="guide-images ${item.imgs.length===1?"one":item.imgs.length===2?"two":""}">
      ${item.imgs.map(([file,label])=>`
       <div class="guide-shot">
        <b>${label}</b>
        <a href="assets/${file}" target="_blank" rel="noopener"><img src="assets/${file}" alt="${label}" loading="lazy"></a>
       </div>`).join("")}
    </div>
    ${item.note?`<div class="guide-note">${item.note}</div>`:""}
  </article>`).join("");
}
...
window.addEventListener("hashchange",()=>{const h=location.hash.replace("#","");if(ROUTES.includes(h))showRoute(h,false)});
